 ...
 */
public class GetAcquisitionPointModel implements Callback{

    private final String GET_ACQUISITION_POINT_MSG_URL = "rest/open/ResourceUIService/getKPIByDeviceId";

    private MyApplication myApplication;
    private GetAcquisitionPointView getEquipmentView;
    ...
    public GetAcquisitionPointModel(Context context, GetAcquisitionPointView getEquipmentView){
        this.getEquipmentView = getEquipmentView;
        this.myApplication = (MyApplication)context.getApplicationContext();
        okHttpUtils = OkHttpUtils.getOkHttpUtils();
    }

    public void getAcquisitionPoint(String deviceId){
        HashMap<String,Object> headMap = new HashMap<>();
        headMap.put("token",myApplication.getSession().getAccess_token());
        HashMap<String,Object> bodyMap = new HashMap<>();
        bodyMap.put("deviceId",deviceId);
        okHttpUtils.doPostAsynValueToHeader(GET_ACQUISITION_POINT_MSG_URL,headMap,bodyMap,this);
    }
